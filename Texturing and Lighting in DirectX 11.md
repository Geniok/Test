...
The  **Blinn-Phong lighting model**  computes the specular contribution slightly differently. Instead of computing the light's reflection vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{R}"/>) about the surface normal (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{N}"/>), a "half-way" vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{H}"/>) between the light vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{L}"/>) and the view vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{V}"/>) is computed. The dot product between the half-way vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{H}"/>) and the surface normal (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{N}"/>) is used as an approximation to the dot product between the reflection vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{R}"/>) and the view vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{V}"/>).

In addition to the previous variables, we must also compute  <img src="https://latex.codecogs.com/gif.latex/?\mathbf{H}"/>  as the half-way (or half-angle) vector between the light vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{L}"/>) and the view vector (<img src="https://latex.codecogs.com/gif.latex/?\mathbf{V}"/>).

If:

-   <img src="https://latex.codecogs.com/gif.latex/?\mathbf{H}"/>  is the half-angle vector between the light vector and the view vector.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk0OTEwODQyMCw0MzQ1ODY3NzNdfQ==
-->