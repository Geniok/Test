...
По-умолчанию, параметр  **MinLOD**  равен  **-FLT_MAX**,  а параметр MaxLOD равен  **FLT_MAX**  which disables any LOD limits.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDM1MzE0MTAsLTY1NjMyOTQ2MywtMT
Q2MjMwMjg4NywtMjEyNTM1NzY0MV19
-->