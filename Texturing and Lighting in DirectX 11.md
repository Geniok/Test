...
Самое большое изображение находится на уровне **0** цепочки mipmap, а самое маленькое изображение находится на уровне  ![](https://www.3dgep.com/texturing-lighting-directx-11/?\log_2(N)) log_2(  ![](https://www.3dgep.com/texturing-lighting-directx-11/?N)  размер в текселях самого длинного края изображения.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA2MzEwMDgyMCwxODYyMzk0MDcxLDE2Nz
MzOTQ1NTVdfQ==
-->