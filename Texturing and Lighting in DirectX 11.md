...
Самое большое изображение находится на уровне **0** цепочки mipmap, а самое маленькое изображение находится на уровне 
<img src="https://latex.codecogs.com/gif.latex?\log_2(N)"/>
где <img src="https://latex.codecogs.com/gif.latex?\N"/>  ![](https://www.3dgep.com/texturing-lighting-directx-11/?N)  размер в текселях самого длинного края изображения.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgyNTMyMTEzNCwxNzc1MTU4NzQxLDE0MT
