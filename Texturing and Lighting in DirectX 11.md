...
Предположим, мы установили цвет границы в пурпурный цвет, а затем на рисунке ниже показан режим адресации границ. Желтые линии показывают целочисленные границы текстурных координат.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODQwMDY2OTksNzM1ODI4NTUzLC01NT
QxNDgyODJdfQ==
-->