...
Использование линейной выборки для minification; точечной для use point sampling for magnification; use linear interpolation for mip-level sampling.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDI1Nzk5MzIsMTYxMDM0ODAxMCwxNj
g2MzQ5MDUxXX0=
-->