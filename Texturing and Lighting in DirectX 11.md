...
Самое большое изображение находится на уровне **0** цепочки мип-карт, а самое маленькое изображение находится на уровне  ![](https://www.3dgep.com/texturing-lighting-directx-11/?\log_2(N))where  ![](https://www.3dgep.com/texturing-lighting-directx-11/?N)  is the size in texels of the longest edge of the image.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUzNzQ1Njk1NiwxNjMyNjE0Mzk4XX0=
-->