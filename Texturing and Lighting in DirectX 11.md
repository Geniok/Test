...
Похоже на  **D3D11_TEXTURE_ADDRESS_MIRROR** и **D3D11_TEXTURE_ADDRESS_CLAMP**. Принимает абсолютное значение текстурной координаты  (таким образом, зеркально отражается относительно 0), а затем устанав максимальное значение.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjYxNTc5MzMsLTEwMDE0OTg5NzBdfQ==
-->